var shouldTrack;
var Effective = /** @class */ (function () {
    function Effective(fn, schedule) {
        this.deps = [];
        this._active = true;
        this._fn = fn;
        this.schedule = schedule;
    }
    Effective.prototype.run = function () {
    ...
    Effective.prototype.stop = function () {
...
function effect(fn, options) {
    ...
    var schedule = options.schedule; options.onStop;
    // 首先需要触发传入的fn，只有当触发了fn才会触发proxy的get方法,进行依赖收集
    var effectFn = new Effective(fn, schedule);
    // 后续只要是有属性都可以合并到实例化对象中去;
    Object.assign(effectFn, options);
    effectFn.run();
    var runner = effectFn.run.bind(effectFn);
 ...
 */
var RefImp = /** @class */ (function () {
    function RefImp(value) {
        this.__v_isRef = true;
    ...
    Object.defineProperty(RefImp.prototype, "value", {
        get: function () {
            if (isTracking()) {
 ...
 * @return
 */
var provider = function (key, data) {
