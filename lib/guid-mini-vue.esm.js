...
function createRenderer(options) {
    const { createElement, patchProps, insert, remove: hostRemove, setElementText: hostSetElementText, removeElementText: hostRemoveElementText, } = options;
    /**
     * 描述：处理虚拟dom渲染的逻辑
     * @param { any } vnode 虚拟dom
     ...
     * @return
     */
    function patch(prevVnode, vnode, container, parent) {
     ...
     * @return void
     */
    function processComponent(prevVnode, vnode, container, parent) {
        // 组件初始化状态的处理
     ...
     * @return void
     */
    function processElement(prevVnode, vnode, container, parent) {
     ...
     * @return
     */
    function patchElement(prevVnode, vnode, container, parent) {
     ...
     * @return
     */
    function processFragment(prevVnode, vnode, container, parent) {
        //  调用mountChildren方法
...
export { createApp, createTextVNode, getCurrentInstance, h, inject, provider, proxyRefs, ref, renderSlots };
